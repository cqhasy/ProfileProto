...
const file_common_Common_proto_rawDesc = "" +
	"\n" +
	"\x13common/Common.proto\x12\fProfileProto\"<\n" +
	...
	"\x05proxy\x10\x02B.Z,github.com/cqhasy/ProfileProto/common;commonb\x06proto3"
...
var file_common_Common_proto_goTypes = []any{
	(DetectPoint)(0),           // 0: ProfileProto.DetectPoint
	(*KeyStringValuePair)(nil), // 1: ProfileProto.KeyStringValuePair
	(*KeyIntValuePair)(nil),    // 2: ProfileProto.KeyIntValuePair
	(*CPU)(nil),                // 3: ProfileProto.CPU
	(*Instant)(nil),            // 4: ProfileProto.Instant
}
