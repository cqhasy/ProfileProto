...
const file_common_Command_proto_rawDesc = "" +
	"\n" +
	"\x14common/Command.proto\x12\fProfileProto\x1a\x13common/Common.proto\"Y\n" +
	"\aCommand\x12\x18\n" +
	"\acommand\x18\x01 \x01(\tR\acommand\x124\n" +
	"\x04args\x18\x02 \x03(\v2 .ProfileProto.KeyStringValuePairR\x04args\"=\n" +
	"\bCommands\x121\n" +
	"\bcommands\x18\x01 \x03(\v2\x15.ProfileProto.CommandR\bcommandsB.Z,github.com/cqhasy/ProfileProto/common;commonb\x06proto3"
...
var file_common_Command_proto_goTypes = []any{
	(*Command)(nil),            // 0: ProfileProto.Command
	(*Commands)(nil),           // 1: ProfileProto.Commands
	(*KeyStringValuePair)(nil), // 2: ProfileProto.KeyStringValuePair
}
var file_common_Command_proto_depIdxs = []int32{
	2, // 0: ProfileProto.Command.args:type_name -> ProfileProto.KeyStringValuePair
	0, // 1: ProfileProto.Commands.commands:type_name -> ProfileProto.Command
