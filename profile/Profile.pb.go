...
import (
	common "github.com/cqhasy/ProfileProto/common"
...
const file_profile_Profile_proto_rawDesc = "" +
	"\n" +
	"\x15profile/Profile.proto\x12\fProfileProto\x1a\x14common/Command.proto\"\x87\x01\n" +
	...
	"\x0flastCommandTime\x18\x03 \x01(\x03R\x0flastCommandTime\"\xb1\x01\n" +
	...
	"\x05stack\x18\x05 \x01(\v2\x19.ProfileProto.ThreadStackR\x05stack\"5\n" +
	"\vThreadStack\x12&\n" +
	...
	"\x06isLast\x18\x06 \x01(\bR\x06isLast2\xd6\x02\n" +
	"\vProfileTask\x12Y\n" +
	"\x16getProfileTaskCommands\x12%.ProfileProto.ProfileTaskCommandQuery\x1a\x16.ProfileProto.Commands\"\x00\x12K\n" +
	"\x0fcollectSnapshot\x12\x1c.ProfileProto.ThreadSnapshot\x1a\x16.ProfileProto.Commands\"\x00(\x01\x12J\n" +
	"\x0fgoProfileReport\x12\x1b.ProfileProto.GoProfileData\x1a\x16.ProfileProto.Commands\"\x00(\x01\x12S\n" +
	"\x10reportTaskFinish\x12%.ProfileProto.ProfileTaskFinishReport\x1a\x16.ProfileProto.Commands\"\x00B\x89\x01\n" +
	"5org.apache.skywalking.apm.network.language.profile.v3P\x01Z.github.com/cqhasy/ProfileProto/profile;profile\xaa\x02\x1dSkyWalking.NetworkProtocol.V3b\x06proto3"
...
var file_profile_Profile_proto_goTypes = []any{
	(*ProfileTaskCommandQuery)(nil), // 0: ProfileProto.ProfileTaskCommandQuery
	(*ThreadSnapshot)(nil),          // 1: ProfileProto.ThreadSnapshot
	(*ThreadStack)(nil),             // 2: ProfileProto.ThreadStack
	(*ProfileTaskFinishReport)(nil), // 3: ProfileProto.ProfileTaskFinishReport
	(*GoProfileData)(nil),           // 4: ProfileProto.GoProfileData
	(*common.Commands)(nil),         // 5: ProfileProto.Commands
}
var file_profile_Profile_proto_depIdxs = []int32{
	2, // 0: ProfileProto.ThreadSnapshot.stack:type_name -> ProfileProto.ThreadStack
	0, // 1: ProfileProto.ProfileTask.getProfileTaskCommands:input_type -> ProfileProto.ProfileTaskCommandQuery
	1, // 2: ProfileProto.ProfileTask.collectSnapshot:input_type -> ProfileProto.ThreadSnapshot
	4, // 3: ProfileProto.ProfileTask.goProfileReport:input_type -> ProfileProto.GoProfileData
	3, // 4: ProfileProto.ProfileTask.reportTaskFinish:input_type -> ProfileProto.ProfileTaskFinishReport
	5, // 5: ProfileProto.ProfileTask.getProfileTaskCommands:output_type -> ProfileProto.Commands
	5, // 6: ProfileProto.ProfileTask.collectSnapshot:output_type -> ProfileProto.Commands
	5, // 7: ProfileProto.ProfileTask.goProfileReport:output_type -> ProfileProto.Commands
	5, // 8: ProfileProto.ProfileTask.reportTaskFinish:output_type -> ProfileProto.Commands
